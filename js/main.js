...
function endScreen() {
  ...
  //Ebbe rkhatsz plusz csst amit szeretnél. Ha az alap csst akarod használni amit rajmund összerakott akkor hagy így mert így törli ki azt amit én raktam össze.
  ...
  "</p>" +
  "</div>";
   //Ide kell beraknod azt hogy mit szeretnél látni a vége résznél
